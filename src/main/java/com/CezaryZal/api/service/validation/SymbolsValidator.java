...
public class SymbolsValidator implements StringValidator, SecondGroupOfMatcher {
    private final List<Character> incorrectSymbols = Arrays.asList('b', 'i', 'l', 'o', 'q');
    ...
    public boolean symbolsIsCorrect(String symbolsFromInput) {
        return isOneLetter(symbolsFromInput) &&
                ...
                notContainsIncorrectSymbol(symbolsFromInput);
    ...
    private boolean notContainsIncorrectSymbol(String symbolsFromInput) {
